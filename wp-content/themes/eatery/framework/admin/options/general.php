...
function theme_general_options() {
	...
	<?php endif; // If the form has just been submitted, this shows the notification ?>
        ...
        and not somewhere else, very important for security */ ?>
            ...
            <div class="theme-options-group">
            <table cellspacing="0" class="widefat theme-options-table">
            <thead><tr><th scope="row" colspan="2"><?php _e('Reservation From','eatery'); ?></th></tr></thead>
            <tbody><tr><th scope="row"><h4><label for="custom_email"><?php _e('24 Hour Clock','eatery'); ?></label></h4></th><td><p class="description"></p><input type="checkbox" id="reso_24_hour_clock" name="sa_general[reso_24_hour_clock]" value="1" <?php checked( true, $settings['reso_24_hour_clock'] ); ?> /> <label for="use_timthumb"><?php _e('Use a 24 hour clock on the reservation form vs AM / PM','eatery'); ?></label></td></tr>
            </table>
            </div>
