...
<p class="submit"><input type="submit" name="save_theme_options" class="button-primary autowidth" value="<?php _e('Save Changes','eatery'); ?>" /></p>
	...
	<p class="submit"><input type="submit" name="save_theme_options" class="button-primary autowidth" value="<?php _e('Save Changes','eatery'); ?>" /></p>
     ...
     <table cellspacing="0" class="widefat theme-options-table">
        <thead><tr><th scope="row" colspan="2"><b>Tiles</b></th></tr></thead>
    		<tbody><tr><th scope="row"><div id="icon-upload" class="icon32"></div><p><?php _e('Background Tile','eatery'); ?></p></th><td><p class="description"><?php _e('Enter a URL or upload a background tile here.','eatery'); ?></p><label for="bg-tile">
    		...
    		<tbody><tr><th scope="row"><div id="icon-upload" class="icon32"></div><p><?php _e('Sidebar Tile','eatery'); ?></p></th><td><p class="description"><?php _e('Enter a URL or upload a sidebar tile here.','eatery'); ?></p><label for="bg-tile">
